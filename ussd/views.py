...
def ussdApp(request):
    ...
    if request.method == 'POST':
        ...
        #  ======================== AMAKURU Y'IGIHINGWA CYA CHIA SEED ==================
            ...
            response += "(1). Izi mbuto iyo uzishyize mu mazi, rumwe rukurura amazi akubye incuro 12 "
            response += "uburemere bwarwo, maze rukabyimba. Izi mbuto ni igihingwa kerera amezi atatu gusa "
            response += "kandi ikiro kimwe cyazo kigura nibura amafaranga y'u Rwanda 3000."
